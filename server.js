...
//       const propertyType = listing.BuildingType || "Apartment";
//       const description = [
//         listing.UnitDescription || `${listing.Beds || 0} bed, ${baths} bath`,
...
//       // Add cooling system if available (common in Boston apartments)
//       listingXml += `
//         <ListingTag type="COOLING_SYSTEM">
//           <tag>Central Air</tag>
//         </ListingTag>`;
...
//       // Additional amenities (example - customize based on YGL data)
//       const amenities = [
//         { type: "PROPERTY_AMENITY", value: "Elevator" },
//         { type: "PROPERTY_AMENITY", value: "Fitness Center" }
//       ];
      
//       amenities.forEach(amenity => {
//         listingXml += `
//         <ListingTag type="${amenity.type}">
//           <tag>${amenity.value}</tag>
//         </ListingTag>`;
//       });
